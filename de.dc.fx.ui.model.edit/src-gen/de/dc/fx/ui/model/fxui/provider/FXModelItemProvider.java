...
/**
 * This is the item provider adapter for a {@link de.dc.fx.ui.model.fxui.FXModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FXModelItemProvider extends FXNamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public FXModelItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FXModel"));
	}
	...
	public String getText(Object object) {
		String label = ((FXModel) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_FXModel_type")
				: getString("_UI_FXModel_type") + " " + label;
	}
