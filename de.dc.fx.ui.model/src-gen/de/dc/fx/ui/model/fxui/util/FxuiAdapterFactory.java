...
public class FxuiAdapterFactory extends AdapterFactoryImpl {
	...
	protected FxuiSwitch<Adapter> modelSwitch = new FxuiSwitch<Adapter>() {
		...
		@Override
		public Adapter caseFXExistingModel(FXExistingModel object) {
			return createFXExistingModelAdapter();
		}
		...
		@Override
		public Adapter caseFXTreeRoot(FXTreeRoot object) {
			return createFXTreeRootAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dc.fx.ui.model.fxui.FXExistingModel <em>FX Existing Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dc.fx.ui.model.fxui.FXTreeRoot <em>FX Tree Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dc.fx.ui.model.fxui.FXNode <em>FX Node</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
