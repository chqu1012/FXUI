...
public interface FxuiPackage extends EPackage
{
   ...
   * @ordered
   */
  int FX_TABLE_VIEW__HAS_FILTER = 0;
   ...
   * @ordered
   */
  int FX_TABLE_VIEW__HAS_SORTER = 1;
   ...
   * @ordered
   */
  int FX_TABLE_VIEW__PACKAGE_PATH = 3;
   ...
   * @ordered
   */
  int FX_TABLE_VIEW__FX_COLUMNS = 4;
   ...
   * @ordered
   */
  int FX_TABLE_VIEW__FX_ENTITY = 5;
   ...
   * @ordered
   */
  int FX_TABLE_VIEW_FEATURE_COUNT = 6;
   ...
   * @ordered
   */
  int FX_COLUMN__USE_CUSTOM_CELL_FACTORY = 1;
   ...
   * @ordered
   */
  int FX_COLUMN__ASSOCIATED_FX_PROPERTY = 5;
   ...
   * @ordered
   */
  int FX_PROPERTY_FEATURE_COUNT = 2;
  ...
  /**
   * Returns the meta object for the attribute '{@link de.dc.fx.ui.model.fxui.FXTableView#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.dc.fx.ui.model.fxui.FXTableView#getName()
   * @see #getFXTableView()
   * @generated
   */
  EAttribute getFXTableView_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.dc.fx.ui.model.fxui.FXColumn#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.dc.fx.ui.model.fxui.FXColumn#getName()
   * @see #getFXColumn()
   * @generated
   */
  EAttribute getFXColumn_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.dc.fx.ui.model.fxui.FXModel#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.dc.fx.ui.model.fxui.FXModel#getName()
   * @see #getFXModel()
   * @generated
   */
  EAttribute getFXModel_Name();
  ...
  /**
   * Returns the meta object for the attribute '{@link de.dc.fx.ui.model.fxui.FXProperty#getName <em>Name</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Name</em>'.
   * @see de.dc.fx.ui.model.fxui.FXProperty#getName()
   * @see #getFXProperty()
   * @generated
   */
  EAttribute getFXProperty_Name();
  ...
  interface Literals
  {
     ...
     * @generated
     */
    EAttribute FX_TABLE_VIEW__NAME = eINSTANCE.getFXTableView_Name();
     ...
     * @generated
     */
    EAttribute FX_COLUMN__NAME = eINSTANCE.getFXColumn_Name();
     ...
     * @generated
     */
    EAttribute FX_MODEL__NAME = eINSTANCE.getFXModel_Name();
     ...
     * @generated
     */
    EAttribute FX_PROPERTY__NAME = eINSTANCE.getFXProperty_Name();
