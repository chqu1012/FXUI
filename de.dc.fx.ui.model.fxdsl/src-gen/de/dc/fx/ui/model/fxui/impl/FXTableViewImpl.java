 ...
 *   <li>{@link de.dc.fx.ui.model.fxui.impl.FXTableViewImpl#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public class FXTableViewImpl extends MinimalEObjectImpl.Container implements FXTableView
{
  /**
  ...
  public void setHasFilter(boolean newHasFilter)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FxuiPackage.FX_TABLE_VIEW__HAS_FILTER, oldHasFilter, hasFilter));
  }
  ...
  public void setHasSorter(boolean newHasSorter)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FxuiPackage.FX_TABLE_VIEW__HAS_SORTER, oldHasSorter, hasSorter));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FxuiPackage.FX_TABLE_VIEW__NAME, oldName, name));
  }
  ...
  public void setPackagePath(String newPackagePath)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FxuiPackage.FX_TABLE_VIEW__PACKAGE_PATH, oldPackagePath, packagePath));
  }
  ...
  public EList<FXColumn> getFxColumns()
  {
    if (fxColumns == null)
    {
      fxColumns = new EObjectContainmentEList<FXColumn>(FXColumn.class, this, FxuiPackage.FX_TABLE_VIEW__FX_COLUMNS);
    }
    return fxColumns;
  }
  ...
  public NotificationChain basicSetFxEntity(FXModel newFxEntity, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FxuiPackage.FX_TABLE_VIEW__FX_ENTITY, oldFxEntity, newFxEntity);
  ...
  public void setFxEntity(FXModel newFxEntity)
  {
    if (newFxEntity != fxEntity)
    {
      ...
      if (fxEntity != null)
        msgs = ((InternalEObject)fxEntity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FxuiPackage.FX_TABLE_VIEW__FX_ENTITY, null, msgs);
      if (newFxEntity != null)
        msgs = ((InternalEObject)newFxEntity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FxuiPackage.FX_TABLE_VIEW__FX_ENTITY, null, msgs);
      msgs = basicSetFxEntity(newFxEntity, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FxuiPackage.FX_TABLE_VIEW__FX_ENTITY, newFxEntity, newFxEntity));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case FxuiPackage.FX_TABLE_VIEW__HAS_SORTER:
        return isHasSorter();
      case FxuiPackage.FX_TABLE_VIEW__NAME:
        return getName();
