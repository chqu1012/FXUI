...
public class FXDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, FXDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFXTableViewAccess().getGroup_5(), "rule__FXTableView__Group_5__0");
			...
			builder.put(grammarAccess.getFXTableViewAccess().getHasFilterAssignment_0(), "rule__FXTableView__HasFilterAssignment_0");
			builder.put(grammarAccess.getFXTableViewAccess().getHasSorterAssignment_1(), "rule__FXTableView__HasSorterAssignment_1");
			builder.put(grammarAccess.getFXTableViewAccess().getNameAssignment_3(), "rule__FXTableView__NameAssignment_3");
			builder.put(grammarAccess.getFXTableViewAccess().getPackagePathAssignment_5_1(), "rule__FXTableView__PackagePathAssignment_5_1");
			builder.put(grammarAccess.getFXTableViewAccess().getFxColumnsAssignment_6_0(), "rule__FXTableView__FxColumnsAssignment_6_0");
			builder.put(grammarAccess.getFXTableViewAccess().getFxColumnsAssignment_6_1(), "rule__FXTableView__FxColumnsAssignment_6_1");
			builder.put(grammarAccess.getFXTableViewAccess().getFxEntityAssignment_7(), "rule__FXTableView__FxEntityAssignment_7");
			...
			builder.put(grammarAccess.getFXColumnAccess().getWidthAssignment_5_1_2(), "rule__FXColumn__WidthAssignment_5_1_2");
			builder.put(grammarAccess.getFXColumnAccess().getAlignmentAssignment_5_2_2(), "rule__FXColumn__AlignmentAssignment_5_2_2");
			builder.put(grammarAccess.getFXColumnAccess().getAssociatedFXPropertyAssignment_5_3_2(), "rule__FXColumn__AssociatedFXPropertyAssignment_5_3_2");
