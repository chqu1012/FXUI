...
import de.dc.fx.ui.model.ide.contentassist.antlr.PartialFXDslContentAssistParser;
import de.dc.fx.ui.model.ide.contentassist.antlr.internal.InternalFXDslLexer;
import de.dc.fx.ui.model.ui.contentassist.FXDslProposalProvider;
import de.dc.fx.ui.model.ui.editor.FXDslEditor;
import de.dc.fx.ui.model.ui.labeling.FXDslDescriptionLabelProvider;
import de.dc.fx.ui.model.ui.labeling.FXDslLabelProvider;
import de.dc.fx.ui.model.ui.outline.FXDslOutlineTreeProvider;
import de.dc.fx.ui.model.ui.quickfix.FXDslQuickfixProvider;
import de.dc.fx.ui.model.validation.FXDslValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link FXDslUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractFXDslUiModule extends DefaultXbaseUiModule {

	public AbstractFXDslUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(de.dc.fx.ui.model.parser.antlr.internal.InternalFXDslLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalFXDslLexer.class).toProvider(LexerProvider.create(InternalFXDslLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return FXDslValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return FXDslLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(FXDslDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return FXDslOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return FXDslQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return FXDslProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialFXDslContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("FXDsl Compare");
	}
